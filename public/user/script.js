...
function createSpiceParticles() {
  const container = document.querySelector(".spice-particles");
  if (!container) return;
  ...
  for (let i = 0; i < 30; i++) {
    ...
    const colors = ["#FFC72C", "#FF9933", "#FF0000", "#8B4513", "#27ae60"];
...
function createBubbles() {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    bubble.style.backgroundColor = `rgba(255, 255, 255, ${Math.random() * 0.5 + 0.3
      })`;
...
>>>>>>> 68880e6e73f67731ca6f45e72193111c2b8ce4b8
